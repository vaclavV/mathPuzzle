...
<html>
  ...
  <div class="tab-content">
    ...
    <div id="menu1" class="tab-pane fade plocha">
      <h3>návrh obrázku</h3>
      <?php if($_GET["obrazek"]=='y'){echo '<H2 class="text-danger">Obrázek byl uložen</h2>';} ?>
                                <div class="container">

                                    <form action="source/ulozObrazek.php"  method="post">
                                        <div class="form-group">
                                            <label for="nazev">Jméno obrázku:</label>
                                            <input name="jmenoObrazku" type="text" class="form-control" id="jemnoObrazku" placeholder="zadej jednoslovný název obrázku">
    ...
    <div id="menu2" class="tab-pane fade plocha">
        <h3>návrh hry</h3><br>
        <?php if($_GET["hra"]=='y'){echo '<H2 class="text-danger">Hra byla uložena</h2>';}?>
         <?php
  ...
  <button type="submit" class="btn btn-default">ulož hru</button>
      ...
      <hr>
      <?php if($_GET["zmena"]=='y'){echo '<H2 class="text-danger">Hra byla vybrána, aktuální hra je: <strong>'.$aktualniHraJmeno->jmenoHry . '</strong></h2>';}
      else{    echo '<strong>aktuální hra: '.  $aktualniHraJmeno->jmenoHry . '</strong>' ;}?>
